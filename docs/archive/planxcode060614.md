...
> **歸檔狀態（2026-07-22）**：已完工（2026-06-14，Phase 0–7 全數完成）。現役見 `voicekey/INDEX.md` + `TROUBLESHOOTING-xcode.md`；前代 Python 方案已移除，設計摘要見 `docs/archive/approach-6-macos.md`。本檔僅供歷史參考。
>
> 建立日期：2026-06-14
