...
已完工的歷史施工藍圖，僅供設計脈絡參考。新 session 請改讀 `AGENTS.md`、`voicekey/INDEX.md`、`voicekey/TROUBLESHOOTING-xcode.md`。

| 檔案 | 完工日期 | 現役對應 |
|---|---|---|
| `plan20260614.md` | 2026-06-14 | `voicekey/` Swift `VocabStore`；前代 Python 實作的歷史設計 |
