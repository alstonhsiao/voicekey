...
/// Lightweight logger: writes to ~/Library/Logs/VoiceKey/app.log and os.Logger.
/// Mirrors approach-6's dual file+console logging.
final class AppLog {
    static let shared = AppLog()

    private let logger = Logger(subsystem: "com.alston.VoiceKey", category: "app")
    private let queue = DispatchQueue(label: "com.alston.VoiceKey.log")
