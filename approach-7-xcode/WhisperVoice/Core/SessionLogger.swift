...
/// DB at ~/.whisper_voice_log.db, chmod 600. Serialized writes.
final class SessionLogger {
    static let dbPath = FileManager.default.homeDirectoryForCurrentUser
        .appendingPathComponent(".whisper_voice_log.db")

    private var db: OpaquePointer?
    private let queue = DispatchQueue(label: "com.alston.WhisperVoice.sessionlog")
